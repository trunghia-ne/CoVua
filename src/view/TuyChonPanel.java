...
public class TuyChonPanel extends JFrame implements ActionListener {
    ...
    public JPanel chonQuanCotheomau() {
        ...
        chonQuanCoTheoMau.setBorder(BorderFactory.createCompoundBorder(BorderFactory.createEmptyBorder(5, 5, 5, 5),
    ...
    public JPanel taonutchon() {
        ...
        buttonPane.setBorder(BorderFactory.createCompoundBorder(BorderFactory.createEmptyBorder(5, 5, 5, 5),
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == ok) {
            CoVua.trangThai = Data.DAKETTHUC;
            CoVua.init();
        }
        setVisible(false);
    }
