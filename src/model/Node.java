...
public class Node implements ObServer {
    ...
    public Node(Node viTri) {
        this(viTri, null);
    }

    @Override
    public String toString() {
        return "nuoc di: " + nuocDi;
    }

    public Node(Node viTri, DiChuyen nuocDi) {
    ...
    public void taoBanCo(boolean humanWhite) {
        ...
        banCo = new int[] { Data.KHUNG, Data.KHUNG, Data.KHUNG, Data.KHUNG, Data.KHUNG, Data.KHUNG, Data.KHUNG,
                Data.KHUNG, Data.KHUNG, Data.KHUNG, Data.KHUNG, Data.KHUNG, Data.KHUNG, Data.KHUNG, Data.KHUNG,
                Data.KHUNG, Data.KHUNG, Data.KHUNG, Data.KHUNG, Data.KHUNG, Data.KHUNG, Data.OTRONG, Data.OTRONG,
                Data.OTRONG, Data.OTRONG, Data.OTRONG, Data.OTRONG, Data.OTRONG, Data.OTRONG, Data.KHUNG, Data.KHUNG,
                Data.OTRONG, Data.OTRONG, Data.OTRONG, Data.OTRONG, Data.OTRONG, Data.OTRONG, Data.OTRONG, Data.OTRONG,
                Data.KHUNG, Data.KHUNG, Data.OTRONG, Data.OTRONG, Data.OTRONG, Data.OTRONG, Data.OTRONG, Data.OTRONG,
                Data.OTRONG, Data.OTRONG, Data.KHUNG, Data.KHUNG, Data.OTRONG, Data.OTRONG, Data.OTRONG, Data.OTRONG,
                Data.OTRONG, Data.OTRONG, Data.OTRONG, Data.OTRONG, Data.KHUNG, Data.KHUNG, Data.OTRONG, Data.OTRONG,
                Data.OTRONG, Data.OTRONG, Data.OTRONG, Data.OTRONG, Data.OTRONG, Data.OTRONG, Data.KHUNG, Data.KHUNG,
                Data.OTRONG, Data.OTRONG, Data.OTRONG, Data.OTRONG, Data.OTRONG, Data.OTRONG, Data.OTRONG, Data.OTRONG,
                Data.KHUNG, Data.KHUNG, Data.OTRONG, Data.OTRONG, Data.OTRONG, Data.OTRONG, Data.OTRONG, Data.OTRONG,
                Data.OTRONG, Data.OTRONG, Data.KHUNG, Data.KHUNG, Data.OTRONG, Data.OTRONG, Data.OTRONG, Data.OTRONG,
                Data.OTRONG, Data.OTRONG, Data.OTRONG, Data.OTRONG, Data.KHUNG, Data.KHUNG, Data.KHUNG, Data.KHUNG,
                Data.KHUNG, Data.KHUNG, Data.KHUNG, Data.KHUNG, Data.KHUNG, Data.KHUNG, Data.KHUNG, Data.KHUNG,
                Data.KHUNG, Data.KHUNG, Data.KHUNG, Data.KHUNG, Data.KHUNG, Data.KHUNG, Data.KHUNG, Data.KHUNG,
                Data.KHUNG };
        for (int i = 0; i < banCo.length; i++) {
    ...
    public void update(DiChuyen diChuyen) {
        ...
        if (viTriDau > 0) {
            ...
            if (viTriCuoi > 0 && viTriCuoi != Data.OTRONG) {
                cacLoaiQuanCoNguoi[viTriCuoi] = null;
            }
        }
        banCo[diChuyen.viTriDau] = Data.OTRONG;
